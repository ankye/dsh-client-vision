...
import { VISION_CHANNELS, VISION_MODELS } from "./vision-card-controller.js";
...
export function VisionCard(props) {
    ...
    return (_jsxs(PluginCard, { t: t, titleKey: "title", descriptionKey: "description", state: state, onSave: props.save, onDiscard: props.discard, children: [_jsx(SecretField, { id: "plugin-config-vision-key", label: t('apiKey'), hint: t('apiKeyHint'), disabled: !state.apiKeyWritable, text: state.apiKey.text, configured: state.apiKeyConfigured, stateLabel: state.apiKeyConfigured ? t('apiKeySet') : t('apiKeyUnset'), onEdit: (text) => { props.edit('apiKey', text); } }), _jsx(ValueField, { id: "plugin-config-vision-endpoint", label: t('baseUrl'), hint: t('baseUrlHint'), placeholder: "https://token.uzstudio.com/v1", overriddenLabel: t('overridden'), resetLabel: t('reset'), invalidLabel: t('invalidNumber'), disabled: disabled, ...state.baseUrl, onEdit: (text) => { props.edit('baseUrl', text); }, onReset: () => { props.resetField('baseUrl'); } }), _jsx(SelectField, { id: "plugin-config-vision-channel", label: t('channel'), hint: t('channelHint'), options: CHANNEL_OPTIONS, overriddenLabel: t('overridden'), resetLabel: t('reset'), invalidLabel: t('invalidNumber'), disabled: disabled, ...state.channel, onEdit: (text) => { props.edit('channel', text); }, onReset: () => { props.resetField('channel'); } }), _jsx(SelectField, { id: "plugin-config-vision-model", label: t('model'), hint: t('modelHint'), options: MODEL_OPTIONS, overriddenLabel: t('overridden'), resetLabel: t('reset'), invalidLabel: t('invalidNumber'), disabled: disabled, ...state.model, onEdit: (text) => { props.edit('model', text); }, onReset: () => { props.resetField('model'); } })] }));
}
