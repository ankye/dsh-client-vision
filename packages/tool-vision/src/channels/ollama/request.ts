 ...
 */
export function resolveOllamaEndpoint(baseUrl: string | undefined): string {
 ...
 */
export function buildOllamaChatBody(model: string | undefined, prompt: string, imageB64: string): unknown {
  return {
 ...
 */
export function ollamaAnswerOf(payload: unknown): string {
